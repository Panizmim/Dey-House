      ...
      <section>
        ...
        <div className="max-w-[1200px] mx-auto px-8 py-16 text-right">
          ...
          <div className="font-light text-[#555] flex flex-col gap-4" style={{ fontSize: 15, lineHeight: 1.9, maxWidth: 820 }}>
            ...
            <p>گالری د‌یـ ده بر آن‌است که نگاه‌های نو و تجربه‌های متفاوت هنری را کنار هم بیاورد و بستری باشد برای هنرمندان آوانگارد و ایده‌هایی که بتوانند با اتمسفر این فضا پیوند برقرار کنند.</p>
            <p>هدف ما ایجاد جریانی منظم و درعین‌حال صمیمی‌ست؛ تصمیمی که نه یک انتخاب فرمالیستی، بلکه بیانی از ماهیت دیــده است: هنر در مرکز، نه در حاشیه.</p>
            <p>نمایش آثار نیز در همین راستا شکل می‌گیرد؛ برای دعوت مخاطب به گفت‌وگو با هنر و هنرمند، بی‌آنکه فاصله‌ای میان او و اثر وجود داشته باشد.</p>
            <p>در دیــ ده، هنر فقط نمایش داده نمی‌شود؛<br />زندگی می‌کند، تغییر می‌دهد و امکان تازه‌ای برای دیدن جهان می‌سازد.</p>
          </div>
        </div>
      </section>
